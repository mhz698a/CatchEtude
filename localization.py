...
STRINGS = {
    "es": {
        ...
        "menu_move_all_in_folder": "Mover todos los archivos en esta carpeta",
        "menu_move_and_open_file": "Mover aqui y abrir el archivo",
        "menu_move_and_open_folder": "Mover aqui y abrir esta carpeta",
        "menu_move_all_and_open_folder": "Mover todos los archivo aqui y abrir esta carpeta",
        ...
        "keep_this_file": "Keep this file in Conflicts",
        "keep_this_file_open_file": "Keep this file in Conflicts and open this file",
        "keep_this_file_open_folder": "Keep this file in Conflicts and open folder",
        "keep_all_files": "Keep all files in conflicts",
        "keep_all_files_open_folder": "Keep all files in Conflicts and open folder",
    ...
    "en": {
        ...
        "menu_move_all_in_folder": "Move all files in this folder",
        "menu_move_and_open_file": "Move here and open file",
        "menu_move_and_open_folder": "Move here and open folder",
        "menu_move_all_and_open_folder": "Move all files here and open folder",
