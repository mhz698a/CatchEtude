...
STRINGS = {
    "es": {
        ...
        "btn_open": "Abrir",
        "btn_recently": "Recently",
        "lbl_type": "Tipo",
        "lbl_characters": "Personajes",
        "lbl_queue": "Cola de descargas",
        "lbl_queue_movings": "Movimientos pendientes",
        "lbl_years": "Años",
        ...
        "lang_toggle": "EN",
        "btn_reload": "Recargar",
        "tooltip_reload": "Resetear cola de descargas y reescaneo",
        "msg_reload_confirm": "¿Estás seguro de que deseas resetear la cola de descargas y volver a escanear? Los archivos encolados por 'Order Pendings' se quitarán de la cola actual.",
        ...
        "plugins_dialog_title": "Administrador de Plugins - CatchEtude",
        "btn_refresh_plugins": "Actualizar",
        "btn_enable_plugin": "Habilitar",
        "btn_disable_plugin": "Deshabilitar",
        "btn_start_plugin": "Iniciar",
        "btn_stop_plugin": "Detener",
        "btn_restart_plugin": "Reiniciar",
        "btn_open_plugins_dir": "Abrir carpeta de plugins",
        "btn_copy_diag": "Copiar diagnóstico",
        "btn_plugin_settings": "Ajustes del plugin",
        "col_plugin_file": "Archivo",
        "col_plugin_id": "ID",
        "col_plugin_name": "Nombre",
        "col_plugin_ver": "Versión",
        "col_plugin_state": "Estado Plugin",
        "col_services_state": "Servicios",
        "col_last_error": "Último Error",
        "msg_trust_title": "Confirmación de seguridad y confianza",
    ...
    "en": {
        ...
        "lbl_queue_movings": "Pending movements",
        "lbl_years": "Years",
        ...
        "lang_toggle": "ES",
        "btn_reload": "Reload",
        "tooltip_reload": "Reset download queue and rescan",
        "msg_reload_confirm": "Are you sure you want to reset the download queue and rescan? Files queued by 'Order Pendings' will be removed from the current queue.",
        "btn_history": "Undo",
        ...
        "plugins_menu": "Plugins",
        "plugins_dialog_title": "Plugin Manager - CatchEtude",
        "btn_refresh_plugins": "Refresh",
        "btn_enable_plugin": "Enable",
        "btn_disable_plugin": "Disable",
        "btn_start_plugin": "Start",
        "btn_stop_plugin": "Stop",
        "btn_restart_plugin": "Restart",
        "btn_open_plugins_dir": "Open plugins folder",
        "btn_copy_diag": "Copy diagnostics",
        "btn_plugin_settings": "Plugin Settings",
        "col_plugin_file": "File",
        "col_plugin_id": "ID",
        "col_plugin_name": "Name",
        "col_plugin_ver": "Version",
        "col_plugin_state": "Plugin State",
        "col_services_state": "Services",
